  ...
  ngOnInit() {
    this.timerId = window.setInterval(() => {
      ...
      if (this.seconds > 0) {
        ...
        //if (this.hours < 10) { this.hours = '0' + this.hours; } //пыталась добавить 0 слева, но пока не получилось из-за преобразования типов
        this.seconds = Math.floor((this.minutes - Math.floor(this.minutes)) * 60); // подсчитываем кол-во оставшихся секунд в текущей минуте
